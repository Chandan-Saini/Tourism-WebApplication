...
var url= process.env.DATABASEURLT || "mongodb://localhost:27017/yelp_camp_v12"      //this line is used so that if our local server restarts or having some connection problem with the local env var then it can connect to the url given 
